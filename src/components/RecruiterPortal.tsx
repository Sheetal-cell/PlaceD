    ...
    <div className="rp-layout">
      ...
      <div className="md:hidden sticky top-16 z-30 bg-white/95 backdrop-blur-md border-b border-slate-200/90 px-4 py-3 h-16 flex items-center justify-between gap-4 shadow-2xs">
        <button
          ...
          className="px-4 py-2.5 rounded-xl bg-sky-50 hover:bg-sky-100 text-sky-900 font-extrabold text-sm border border-sky-200/80 transition-all cursor-pointer flex items-center gap-2.5 shadow-2xs active:scale-95 shrink-0 min-h-[44px]"
        >
          <Menu size={22} className="text-sky-600 shrink-0" />
          <span className="font-display">Recruiter Menu</span>
        </button>
        <span className="px-3 py-1 rounded-full text-[10px] font-extrabold uppercase tracking-wider bg-sky-50 text-sky-700 border border-sky-200/80 font-mono truncate">
          {activeTab}
        </span>
      </div>
